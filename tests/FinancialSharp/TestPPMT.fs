...
type TestPPMT() = 
    ...
    member _.``ppmt with paymentDuePeriod = PaymentDuePeriod.Begin``(rate:double, per:double, nper:double, pv:double, fv:double, expectedResult:double) = 
    ...
    member _.``ppmt with paymentDuePeriod = PaymentDuePeriod.End``(rate:double, per:double, nper:double, pv:double, fv:double, expectedResult:double) = 
